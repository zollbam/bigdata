...
, IFNULL(REPLACE(ifnull(CASE WHEN pi2.DANJI_NO IN (NULL, 0) THEN NULL ELSE pi2.DANJI_NO END, atai.APT_NO),CONCAT(CHAR(10)), ''), '') hsmp_info_pk
...
, IFNULL(REPLACE(ifnull(CASE WHEN pi2.MM_DONG_NM IN (NULL, '') THEN NULL ELSE pi2.MM_DONG_NM END, atai.APT_DONG),CONCAT(CHAR(10)), ''), '') aptcmpl_nm
, IFNULL(REPLACE(HO_NM, CONCAT(CHAR(10)), ''), '') ho_nm
, CASE WHEN PRODUCT_LAT IN (NULL, 0) THEN ''
   ...
   END atlfsl_crdnt 
, CASE WHEN PRODUCT_LNG IN (NULL, 0) THEN ''
...
, IFNULL(REPLACE(OPEN_APT_DONG_YN,CONCAT(CHAR(10)), ''), '') bldg_aptcmpl_indct_yn
...
, IFNULL(REPLACE(pi2.UPDT_DT,CONCAT(CHAR(10)), ''), '') mdfcn_dt
 ...
 where pi2.PRODUCT_CATE_CD not in ('03', '04') -- 주상복합, 주상복합분양권 제외
   AND pi2.PRODUCT_NO NOT IN (20502829, 0)
 LIMIT 10000000;
...
, IFNULL(REPLACE(ifnull(CASE WHEN pi2.DANJI_NO IN (NULL, 0) THEN NULL ELSE pi2.DANJI_NO END, atai.APT_NO),CONCAT(CHAR(10)), ''), '') hsmp_info_pk
, IFNULL(REPLACE(DANJI_DETAIL_NO,CONCAT(CHAR(10)), ''), '') hsmp_dtl_info_pk 
, IFNULL(REPLACE(substring(ifnull(ifnull(ifnull(atai.ARTICLE_TYPE, atci.ARTICLE_TYPE), atdi.ARTICLE_TYPE), atei.ARTICLE_TYPE), 1, 1),CONCAT(CHAR(10)), ''), '') atlfsl_ty_cd 
, IFNULL(REPLACE(ifnull(ifnull(ifnull(atai.ARTICLE_TYPE, atci.ARTICLE_TYPE), atdi.ARTICLE_TYPE), atei.ARTICLE_TYPE),CONCAT(CHAR(10)), ''), '') atlfsl_dtl_ty_cd 
, IFNULL(REPLACE(PRODUCT_CATE_CD,CONCAT(CHAR(10)), ''), '') atlfsl_knd_cd 
, IFNULL(REPLACE(ADDR_CODE,CONCAT(CHAR(10)), ''), '') stdg_dong_cd
, IFNULL(REPLACE(ifnull(ifnull(ifnull(atai.CORTAR_NO, atci.CORTAR_NO), atdi.CORTAR_NO), atei.CORTAR_NO),CONCAT(CHAR(10)), ''), '') stdg_cd 
, IFNULL(REPLACE(BDONG_NO, CONCAT(CHAR(10)), ''), '') stdg_innb 
, IFNULL(REPLACE(HDONG_NO, CONCAT(CHAR(10)), ''), '') dong_innb 
, CASE WHEN LENGTH(BON_NO)<=4 THEN IFNULL(REPLACE(BON_NO,CONCAT(CHAR(10)), ''), '') ELSE '' END mno 
, CASE WHEN LENGTH(BU_NO)<=4 THEN IFNULL(REPLACE(BU_NO,CONCAT(CHAR(10)), ''), '') ELSE '' END sno 
...
select 
  IFNULL(REPLACE(BANNER_NO,CONCAT(CHAR(10)), ''), '') banner_info_pk
, IFNULL(REPLACE(BAN_TYPE,CONCAT(CHAR(10)), ''), '') banner_ty_cd
, '' banner_se_cd
, IFNULL(REPLACE(IMG_URL_BAN,CONCAT(CHAR(10)), ''), '') thumb_img_url
, IFNULL(REPLACE(IMG_ORDER,CONCAT(CHAR(10)), ''), '') banner_ordr
, IFNULL(REPLACE(BANNER_USE_YN,CONCAT(CHAR(10)), ''), '') use_yn
, IFNULL(REPLACE(BAN_URL_ADDRESS,CONCAT(CHAR(10)), ''), '') url
, '' img_url
, '' dtl_cn
